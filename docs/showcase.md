...
Here are all the cool projects that people have built using `buddy`.
...
The whole Stacks ecosystem is built using `buddy`. Here are some of the projects utilizing it:
...
- [`buddy`](https://github.com/stacksjs/stacks/tree/main/storage/framework/core/buddy)
